...
public class DriverMonitorSettingActivity extends DrivermonitorBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.gate_settting_back) {
            ...
            Intent intent = new Intent(DriverMonitorSettingActivity.this, PictureOptimizationActivity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(DriverMonitorSettingActivity.this, LogSettingActivity.class);
            startActivity(intent);
        }
    }
}