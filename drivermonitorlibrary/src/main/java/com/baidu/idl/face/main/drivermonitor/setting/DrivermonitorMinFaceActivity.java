...
public class DrivermonitorMinFaceActivity extends DrivermonitorBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drivermonitor_minface);
    ...
    public void init() {
        ...
        minFace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(minRepresent, minFaceText, DrivermonitorMinFaceActivity.this,
        ...
        minFaceThreshold.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(faceThreshold, minFaceThreshold, DrivermonitorMinFaceActivity.this,
