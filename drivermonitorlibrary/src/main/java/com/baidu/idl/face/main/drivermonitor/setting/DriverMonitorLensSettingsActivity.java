...
public class DriverMonitorLensSettingsActivity extends DrivermonitorBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drivermonitor_lens_settings);
