...
public class FaceLivinessTypeActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gaze_facelivinesstype);
        init();
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.fls_save) {
            ...
            boolean checked = qcLiving.isChecked();
            if (checked == false) {
                SingleBaseConfig.getBaseConfig().setType(zero);
            }

            Log.i("wangshu", checked + "");
            ...
            startActivity(new Intent(FaceLivinessTypeActivity.this, GazeLensSelectionActivity.class));
