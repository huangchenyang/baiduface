    ...
    public void init() {
        ...
        minFace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(minRepresent, minFaceText, MinFaceActivity.this,
        ...
        minFaceThreshold.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(faceThreshold, minFaceThreshold, MinFaceActivity.this,
