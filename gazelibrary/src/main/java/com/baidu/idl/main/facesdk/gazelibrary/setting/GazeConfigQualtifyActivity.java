...
public class GazeConfigQualtifyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gaze_config_qualtify);
        init();
    }
    ...
    public void setClickListener() {
        ...
        cwGesture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerGesture, tvGesture, GazeConfigQualtifyActivity.this,
        ...
        cwIlluminiation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerIlluminiation, tvIlluminiation, GazeConfigQualtifyActivity.this,
        ...
        cwBlur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerBlur, tvBlur, GazeConfigQualtifyActivity.this,
        ...
        cwocclusion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerocclusion, tvocclusion, GazeConfigQualtifyActivity.this,
