...
import com.baidu.idl.face.main.finance.activity.finance.FaceDeptrumFinanceActivity;
import com.baidu.idl.face.main.finance.activity.finance.FaceLimFinanceActivity;
...
import com.baidu.idl.main.facesdk.activity.gate.FaceDeptrumGateActivity;
import com.baidu.idl.main.facesdk.activity.gate.FaceLimActivity;
...
import com.baidu.idl.main.facesdk.attendancelibrary.attendance.FaceDeptrumAttendanceActivity;
import com.baidu.idl.main.facesdk.attendancelibrary.attendance.FaceLimAttendanceActivity;
...
import com.baidu.idl.main.facesdk.identifylibrary.activity.FaceDepthTestimonyActivity;
import com.baidu.idl.main.facesdk.identifylibrary.activity.FaceDeptrumPersonActivity;
import com.baidu.idl.main.facesdk.identifylibrary.activity.FaceIRTestimonyActivity;
import com.baidu.idl.main.facesdk.identifylibrary.activity.FaceLimPersonActivity;
import com.baidu.idl.main.facesdk.identifylibrary.activity.FaceRGBIRDepthTestimonyActivity;
...
import com.baidu.idl.main.facesdk.paymentlibrary.activity.payment.FaceDeptrumPaymentActivity;
import com.baidu.idl.main.facesdk.paymentlibrary.activity.payment.FaceLimPaymentActivity;
...
import com.baidu.idl.main.facesdk.registerlibrary.user.register.FaceRegisterDeptrumActivity;
import com.baidu.idl.main.facesdk.registerlibrary.user.register.FaceRegisterLimActivity;
...
//                        FileUtils.saveDBList(HomeActivity.this, users);
    ...
    protected void onResume() {
        boolean isRegisterInitConfig = com.baidu.idl.main.facesdk.
                registerlibrary.user.utils.RegisterConfigUtils.initConfig();
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.relative_register: // 人脸注册
                ...
                dismissPopupWindow();
                mLiveType = com.baidu.idl.main.facesdk.registerlibrary.user.model.
                        SingleBaseConfig.getBaseConfig().getType();
                FaceSDKManager.getInstance().setActiveLog();
                cameraType = com.baidu.idl.main.facesdk.registerlibrary.user.model.
                        SingleBaseConfig.getBaseConfig().getCameraType();
                judgeLiveType(mLiveType, cameraType ,
                        FaceRegisterNewActivity.class, FaceRegisterNewNIRActivity.class,
                        FaceRegisterNewDepthActivity.class, FaceRegisterNewRgbNirDepthActivity.class ,
                        FaceRegisterLimActivity.class , FaceRegisterDeptrumActivity.class);
                break;
            ...
            case R.id.home_gateRl:
                ...
                judgeLiveType(mLiveType , cameraType,
                        ...
                        FaceLimActivity.class,
                        FaceDeptrumGateActivity.class);
                break;
            case R.id.home_checkRl:
                ...
                cameraType = com.baidu.idl.main.facesdk.attendancelibrary.
                        model.SingleBaseConfig.getBaseConfig().getCameraType();
                // 考勤模块
                judgeLiveType(mLiveType, cameraType ,
                        ...
                        FaceLimAttendanceActivity.class,
                        FaceDeptrumAttendanceActivity.class);
                break;
            case R.id.home_payRl:
                ...
                cameraType = com.baidu.idl.main.facesdk.paymentlibrary.model.SingleBaseConfig
                        .getBaseConfig().getCameraType();
                ...
                judgeLiveType(mLiveType,  cameraType,
                        ...
                        FaceLimPaymentActivity.class,
                        FaceDeptrumPaymentActivity.class
                );
                break;
            case R.id.home_livenessRl:
                ...
                cameraType = com.baidu.idl.face.main.finance.model.SingleBaseConfig
                        .getBaseConfig().getCameraType();
                // 金融活检
                judgeLiveType(mLiveType, cameraType ,
                        ...
                        FaceRGBFinanceActivity.class ,
                        FaceLimFinanceActivity.class ,
                        FaceDeptrumFinanceActivity.class);
                break;
            ...
            case R.id.home_personRl:
                ...
                cameraType = com.baidu.idl.main.facesdk.identifylibrary.model.SingleBaseConfig
                        .getBaseConfig().getCameraType();
                ...
                judgeLiveType(mLiveType, cameraType,
                        ...
                        FaceLimPersonActivity.class,
                        FaceDeptrumPersonActivity.class);
                break;
    ...
    private void judgeLiveType(int type, int cameraType, Class<?> rgbCls,
                               Class<?> nirCls, Class<?> depthCls, Class<?> rndCls, Class<?> cameraCls ,
                               Class<?> deptrumCls) {
        switch (type) {
            case 0: { // 不使用活体
                ...
                if (cameraType == 7){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            startActivity(new Intent(HomeActivity.this, cameraCls));
                        }
                    },2000);
                } else if (cameraType == 8){

                    startActivity(new Intent(HomeActivity.this, deptrumCls));
                } else{
            ...
            case 4: { // rgb+nir+depth活体
                if (cameraType == 7 ){
                    ...
                    startActivity(new Intent(HomeActivity.this, rndCls));
                }
            }
        }
    }
