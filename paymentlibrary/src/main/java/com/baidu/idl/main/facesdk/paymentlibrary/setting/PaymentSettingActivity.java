...
public class PaymentSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.gate_settting_back) {
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, GateMinFaceActivity.class);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, GateConfigQualtifyActivity.class);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, FaceLivinessTypeActivity.class);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, GateFaceDetectActivity.class);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, GateLensSettingsActivity.class);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, VersionMessageActivity.class);
            startActivityForResult(intent , 105);
        } else if (id == R.id.gate_picture_optimization){
            Intent intent = new Intent(PaymentSettingActivity.this, PictureOptimizationActivity.class);
            ...
            Intent intent = new Intent(PaymentSettingActivity.this, LogSettingActivity.class);
