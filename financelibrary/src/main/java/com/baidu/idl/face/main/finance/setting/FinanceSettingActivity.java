...
public class FinanceSettingActivity extends BaseActivity implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            if (id == R.id.gate_settting_back) {
                ...
                Intent intent = new Intent(FinanceSettingActivity.this, GateMinFaceActivity.class);
                ...
                Intent intent = new Intent(FinanceSettingActivity.this, GateConfigQualtifyActivity.class);
                ...
                Intent intent = new Intent(FinanceSettingActivity.this, GateLensSettingsActivity.class);
