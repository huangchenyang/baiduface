...
public class FaceRGBFinanceActivity extends BaseActivity implements View.OnClickListener {
...
//                                                textCompareStatus.setMaxEms(6);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_back) {
            ...
            if (isSaveImage){
                ...
                ToastUtils.toast(FaceRGBFinanceActivity.this, "存图功能已开启再次点击可关闭");
            }else {
                spot.setVisibility(View.GONE);
            }
        }
    ...
    private void payHint(final LivenessModel livenessModel) {
        ...
        if (mIsPayHint && livenessModel != null) {
            ...
            if (!TextUtils.isEmpty(livenessModel.getQualityDetect()) ||
                    !TextUtils.isEmpty(livenessModel.getQualityOcclusion())) {
                if (mIsPayHint) {
