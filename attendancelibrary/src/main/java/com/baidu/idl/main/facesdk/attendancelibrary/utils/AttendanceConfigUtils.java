 ...
 */
public class AttendanceConfigUtils {
    ...
    public static boolean isConfigExit(Context context) {
        ...
        filePath =  folder + "/" + "attendanceFaceConfig.txt";
        RegisterConfigUtils.folder = folder;
        RegisterConfigUtils.filePath = folder + "/" + "registerFaceConfig.txt";
