...
public class AttendanceSettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.gate_settting_back) {
            ...
            Intent intent = new Intent(AttendanceSettingActivity.this, GateMinFaceActivity.class);
            ...
            Intent intent = new Intent(AttendanceSettingActivity.this, GateConfigQualtifyActivity.class);
            ...
            Intent intent = new Intent(AttendanceSettingActivity.this, GateFaceDetectActivity.class);
            ...
            Intent intent = new Intent(AttendanceSettingActivity.this, GateLensSettingsActivity.class);
            ...
            Intent intent = new Intent(AttendanceSettingActivity.this, PictureOptimizationActivity.class);
            ...
            Intent intent = new Intent(AttendanceSettingActivity.this, LogSettingActivity.class);
