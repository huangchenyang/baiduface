...
public class AttrbuteMinFaceActivity extends AttributeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attrbute_minface);
    ...
    public void init() {
        ...
        PWTextUtils.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                minFace.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
                minFaceThreshold.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
            }
        });
        // 人脸置信度 增减按钮
        ...
        minFace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                minFace.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(minRepresent, minFaceText, AttrbuteMinFaceActivity.this,
        ...
        minFaceThreshold.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                minFaceThreshold.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(faceThreshold, minFaceThreshold, AttrbuteMinFaceActivity.this,
