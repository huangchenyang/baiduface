    ...
    private void initView() {
        ...
        PWTextUtils.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                cwDetectMirror.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
                cwCameraDisplayMirror.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
            }
        });
        ...
        cwDetectMirror.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwDetectMirror.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(linerDetectMirror, tvDetectMirror, AttributeLensSettingActivity.this,
        ...
        cwCameraDisplayMirror.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwCameraDisplayMirror.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(linerCameraDisplayMirror,
                        tvCameraDisplayMirror, AttributeLensSettingActivity.this,
