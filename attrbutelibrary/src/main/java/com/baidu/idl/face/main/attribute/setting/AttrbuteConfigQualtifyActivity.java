...
public class AttrbuteConfigQualtifyActivity extends AttributeBaseActivity {
    ...
    public void init() {
        ...
        PWTextUtils.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                cwGesture.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
                cwBlur.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
                cwIlluminiation.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
                cwocclusion.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question));
            }
        });
    ...
    public void setClickListener() {
        ...
        qcIlluminiationDecrease.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (illuminiationValue > 0f && illuminiationValue <= 1f) {
                    illuminiationDecimal = new BigDecimal(illuminiationValue + "");
                    illuminiationValue = illuminiationDecimal.subtract(obNonmoralValue).floatValue();
                    qcIlluminiationEtThreshold.setText(illuminiationValue + "");
                }
            }
        });
        ...
        qcIlluminiationIncrease.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (illuminiationValue >= 0f && illuminiationValue < 1f) {
                    illuminiationDecimal = new BigDecimal(illuminiationValue + "");
                    illuminiationValue = illuminiationDecimal.add(obNonmoralValue).floatValue();
                    qcIlluminiationEtThreshold.setText(illuminiationValue + "");
                }
            }
        });
        ...
        qcSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SingleBaseConfig.getBaseConfig().setIllumination(
                        Float.valueOf(qcIlluminiationEtThreshold.getText().toString()));
        ...
        cwGesture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwGesture.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(linerGesture, tvGesture, AttrbuteConfigQualtifyActivity.this,
        ...
        cwIlluminiation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwIlluminiation.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(linerIlluminiation, tvIlluminiation, AttrbuteConfigQualtifyActivity.this,
        ...
        cwBlur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwBlur.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(linerBlur, tvBlur, AttrbuteConfigQualtifyActivity.this,
        ...
        cwocclusion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cwocclusion.setBackground(getDrawable(R.mipmap.attribute_icon_setting_question_hl));
                PWTextUtils.showDescribeText(linerocclusion, tvocclusion, AttrbuteConfigQualtifyActivity.this,
