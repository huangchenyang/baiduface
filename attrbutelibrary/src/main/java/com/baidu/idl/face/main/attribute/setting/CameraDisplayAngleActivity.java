...
import com.baidu.idl.face.main.attribute.view.PreviewTexture;
 ...
 */
public class CameraDisplayAngleActivity extends AttributeBaseActivity {
    ...
    private AttrbuteAutoTexturePreviewView rgbFaceView;
    ...
    private AttrbuteAutoTexturePreviewView nirFaceView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attbute_cameradisplayangle);
        initMode();
    }
    ...
    public void setDisplayOrientation(Camera camera, int videoDirection, AttrbuteAutoTexturePreviewView mTextureView){
    ...
    // 镜像
    public void setRotationY(int videoDirection, int isRgbRevert, AttrbuteAutoTexturePreviewView mTextureView){
        if (videoDirection == 90 || videoDirection == 270) {
            if (isRgbRevert == 1) {
