    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btn_back) {
            ...
            if (isSaveImage){
                ...
                ToastUtils.toast(FaceRGBIRDepthTestimonyActivity.this, "存图功能已开启再次点击可关闭");
            }else {
                spot.setVisibility(View.GONE);
            }
        }
...
//        SystemClock.sleep(30);
    ...
    private synchronized void checkData() {
        if (bdFaceImageConfig.data != null && bdNirFaceImageConfig.data != null && bdDepthFaceImageConfig != null){
            if (bdFaceCheckConfig.getSecondFeature() != null) {
                FaceSDKManager.getInstance().onDetectCheck(
                        bdFaceImageConfig, bdNirFaceImageConfig, bdDepthFaceImageConfig,
