 ...
 */
public class FaceRegisterDeptrumActivity extends BaseDeptrumActivity implements View.OnClickListener {
    private static final String TAG = FaceRegisterDeptrumActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        initListener();
        setContentView(R.layout.activity_new_deptrum_registerlibrary);
    ...
    private void initView() {
        ...
        mCircleHead.setBorderWidth(DensityUtils.dip2px(FaceRegisterDeptrumActivity.this, 3));
    ...
    private void checkFaceBound(final LivenessModel livenessModel) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                FaceOnDrawTexturViewUtil.converttPointXY(mPointXY, mantleGLFrameSurface,
                ...
                float previewWidth = mantleGLFrameSurface.circleRadius * 2;
