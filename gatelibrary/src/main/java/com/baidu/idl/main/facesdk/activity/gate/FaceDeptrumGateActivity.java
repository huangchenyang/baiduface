...
public class FaceDeptrumGateActivity extends BaseDeptrumActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_deptrum_gate);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_back) {
            ...
            if (isSaveImage){
                ...
                ToastUtils.toast(FaceDeptrumGateActivity.this, "存图功能已开启再次点击可关闭");
            }else {
